...
<tileset name="Ground" tilewidth="16" tileheight="16" tilecount="204" columns="17">
 <properties>
  <property name="standalone" value="0"/>
 </properties>
 <image source="../textures/tileset.png" trans="ff00ff" width="272" height="192"/>
 <terraintypes>
  <terrain name="Forest" tile="23">
   <properties>
    <property name="reduced" value="3,4,20,21"/>
    <property name="standalone" value="37,38"/>
   </properties>
  </terrain>
  <terrain name="Water" tile="32"/>
  <terrain name="Lowground" tile="97"/>
  <terrain name="Rocks" tile="176">
   <properties>
    <property name="reduced" value="156,157,173,174"/>
    <property name="standalone" value="190,191"/>
   </properties>
  </terrain>
